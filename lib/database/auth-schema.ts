import { bigint, bigserial, boolean, index, jsonb, numeric, pgTable, text, timestamp, uniqueIndex } from 'drizzle-orm/pg-core'
...
export const sponsors = pgTable('sponsors', {
  ...
  uniqueIndex('idx_sponsors_order_id').on(table.orderId),
